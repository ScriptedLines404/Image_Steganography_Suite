      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <section id="techniques">
          <div className="group relative mb-16">
            ...
            <div className="relative bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-lg rounded-2xl p-10 border border-white/10">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">
                <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                  Steganography Techniques
                </span>
              </h2>
              <p className="text-xl text-gray-300 text-center leading-relaxed max-w-4xl mx-auto mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {techniques.map((technique, index) => (
                  <div key={index} className="group relative">
                    ...
                    <div className="relative bg-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 h-full">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-400">{technique.howItWorks}</p>
                        </div>
                        
                        <div>
                          <h4 className="text-sm font-semibold text-purple-300 mb-1">Best for:</h4>
                          <p className="text-sm text-gray-400">{technique.useCase}</p>
                        </div>
                      </div>
